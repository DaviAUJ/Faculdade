...
int32_t* mediana(int32_t* a, int32_t* b, int32_t* c) {
    int32_t x = *a - *b;
    int32_t y = *b - *c;
    int32_t z = *a - *c;
...
int32_t hoareRandom(int32_t* vetor, int32_t inicio, int32_t fim) {
    trocarInt32(&vetor[inicio], &vetor[inicio + (rand() % (fim - inicio + 1))]);
...
int32_t lomutoRandom(int32_t* vetor, int32_t inicio, int32_t fim) {
    trocarInt32(&vetor[fim], &vetor[inicio + (rand() % (fim - inicio + 1))]);
