...
console.log("\nBUSCAR POR GÊNERO: \n\n",
buscarPorGenero(livros,"Fantasia"))

//Função para remover livro
console.log("\nLIVRO REMOVIDO: \n\n",
removerLivro(livros, "Os Miseráveis"))

                        //OPCIONAIS
//Função para ordenar os livros por ano
console.log("\nANO DOS LIVROS EM ORDEM ANTIGO-NOVO: \n\n",
ordenarPorAno(livros))

//Função para contagem de livros por gênero
console.log("\nQUANTOS LIVROS DO GÊNERO ESTÃO PRESENTES: \n\n",
contagemPorGenero(livros,"Fantasia"))

//Função para Editar detalhes do livro
console.log("\nEDIÇÃO DOS DETALHES DO LIVRO: \n\n",
editarLivro(livros,3,"genero","medieval"))